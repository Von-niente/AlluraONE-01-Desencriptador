...
replace(/imes/gi, "i").replace(/ai/gi, "a").replace(/ober/gi, "o").replace(/ufat/gi, "u"); 
...
// _______boton copiar___________//
function copiar(){
    var conenido = document.querySelector(".text-input-salida");
    contenido.select();
